...
def fill_wrfinput(rootgrp_in, rootgrp_out, laimo=8):
    '''
...
def main_ncdfpy(geoFile, wrfinFile, lai=8, outNCType='NETCDF4'):
    ...
    soildimension = rootgrp_out.createDimension(soildim, 4)                     # Add soil_layers_stag dimension
    ...
    rootgrp_in, rootgrp_out = fill_wrfinput(rootgrp_in, rootgrp_out, laimo=lai)
