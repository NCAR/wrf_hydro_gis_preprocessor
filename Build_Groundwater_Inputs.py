...
# Outputs - permanent
out_zip = os.path.join(out_dir, 'GroundwaterBasins_frxst.zip')
...
saveBasins_Fine = True
saveBasins_Coarse = True
...
if __name__ == '__main__':
    ...
    strm = fine_grid.numpy_to_Raster(rootgrp2.variables['CHANNELGRID'][:])
    ...
    out_ds1 = flowdir = out_ds2 = strm = None
